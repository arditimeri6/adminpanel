...
* Show companies
*/
Route::get('companies/{slug}', 'FrontendController@showCompany')->name('companies.show');

/*
* Show projects
*/
Route::get('projects/{slug}', 'FrontendController@showProject')->name('projects.show');

/*
* Show tasks
*/
Route::get('tasks/{slug}', 'FrontendController@showTask')->name('tasks.show');
